...
`react-a11y-anchors`            | For accessibility of your website, anchor element link text should be at least 4 characters long. (http://oaa-accessibility.org/wcag20/rule/38/) <br/>Links with the same HREF should have the same link text. (http://oaa-accessibility.org/wcag20/rule/39/) <br/>Links that point to different HREFs should have different link text. (http://oaa-accessibility.org/wcag20/rule/41/) <br/>Links with images and text content, the alt attribute should be unique to the text content or empty. (http://oaa-accessibility.org/wcag20/rule/43/) <br/>Enforce an anchor element's href prop value is not just #. | 2.0.10
