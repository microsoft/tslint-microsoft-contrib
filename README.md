...
`no-unused-imports`             | Remove unused imports. There is some overlap between this rule and tslint's no-unused-variables rule. However, the no-unused-imports rule finds more imports than tslint's rule so we recommend you turn it on. | 0.0.1
