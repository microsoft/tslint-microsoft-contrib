...
describe('reactA11yAccessibleHeadingsRule', (): void => {
    ...
    it('should pass when headings are unordered (binded to different variables)', (): void => {
        const script: string = `
            import React = require('react');
            const someComponent1  = () => <h2>test</h2>;
    ...
    it('should pass when heading numbers are not increasing by one at a time (binded to different variables)', (): void => {
        const script: string = `
            import React = require('react');
