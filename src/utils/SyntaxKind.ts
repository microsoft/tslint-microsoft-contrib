...
export module SyntaxKind {
    export interface SyntaxKind {
        ...
        GlobalModuleExportDeclaration?: number; // 1.9 only
        NonNullExpression?: number; // 1.9 only
        UndefinedKeyword?: number; // 1.9 only
        NeverKeyword?: number; // 1.9 only
        ReadonlyKeyword?: number; // 1.9 only
        NamespaceExportDeclaration?: number; // 2.0 only
        JSDocTypedefTag?: number; // 2.0 only
        JSDocPropertyTag?: number;
        FirstJSDocNode?: number; // 2.0 only
        LastJSDocNode?: number; // 2.0 only
        FirstJSDocTagNode?: number; // 2.0 only
        LastJSDocTagNode?: number; // 2.0 only
        JSDocTypeLiteral?: number; // 2.0 only
    }

    let cachedKinds: SyntaxKind.SyntaxKind;

    /* tslint:disable:variable-name */
    const SyntaxKind_1_5: SyntaxKind = {
    ...
    /* tslint:disable:variable-name */
    const SyntaxKind_1_6: SyntaxKind = {
        /* tslint:enable:variable-name */
        Unknown: 0,
        EndOfFileToken: 1,
        SingleLineCommentTrivia: 2,
    ...
    /* tslint:disable:variable-name */
    const SyntaxKind_1_7: SyntaxKind = {
        /* tslint:enable:variable-name */
        Unknown: 0,
        EndOfFileToken: 1,
        SingleLineCommentTrivia: 2,
    ...
    /* tslint:disable:variable-name */
    const SyntaxKind_1_8: SyntaxKind = {
        /* tslint:enable:variable-name */
        Unknown: 0,
        EndOfFileToken: 1,
        SingleLineCommentTrivia: 2,
    ...
    /* tslint:disable:variable-name */
    const SyntaxKind_1_9: SyntaxKind = {
        /* tslint:enable:variable-name */
        Unknown: 0,
        EndOfFileToken: 1,
        SingleLineCommentTrivia: 2,
    ...
    /* tslint:disable:variable-name */
    const SyntaxKind_2_0: SyntaxKind = {
        /* tslint:enable:variable-name */
        Unknown: 0,
        EndOfFileToken: 1,
        SingleLineCommentTrivia: 2,
