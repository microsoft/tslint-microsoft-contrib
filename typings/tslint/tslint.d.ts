...
declare module TypeScript {
    ...
    class Diagnostic {
        ...
        private _arguments;
        constructor(fileName: string, lineMap: TypeScript.LineMap, start: number, length: number, diagnosticKey: string, args?: any[]);
...
declare module TypeScript {
    ...
    class ArgumentListSyntax extends TypeScript.SyntaxNode {
        ...
        public closeParenToken: TypeScript.ISyntaxToken;
        constructor(typeArgumentList: TypeArgumentListSyntax, openParenToken: TypeScript.ISyntaxToken, args: TypeScript.ISeparatedSyntaxList, closeParenToken: TypeScript.ISyntaxToken, parsedInStrictMode: boolean);
        public accept(visitor: TypeScript.ISyntaxVisitor): any;
        public kind(): TypeScript.SyntaxKind;
        public childCount(): number;
        public childAt(slot: number): TypeScript.ISyntaxElement;
...
declare module TypeScript {
    ...
    class ArgumentList extends AST {
        ...
        constructor(typeArgumentList: TypeArgumentList, args: ISeparatedSyntaxList2, closeParenToken: ASTSpan);
        public kind(): TypeScript.SyntaxKind;
    }
...
declare module TypeScript {
    ...
    class SemanticInfoChain {
        ...
        public addDiagnosticFromAST(ast: TypeScript.AST, diagnosticKey: string, any?: any[]): void;
        public diagnosticFromAST(ast: TypeScript.AST, diagnosticKey: string, args?: any[]): TypeScript.Diagnostic;
    }
}
declare module TypeScript {
